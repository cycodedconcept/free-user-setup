...
import { createOnlineStore, resetStatus, getAllServices, getCollectionForProduct, productImageForCollection, getMyOnlineStore } from '../../../slice/onlineStoreSlice';
...
const SetupStore = () => {
  ...
  const { loading, error, success, allStore, collectionProduct, myStore } = useSelector((state) => state.store);
